...
class IssueRulesTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $expects = ['format' => 'Ymd[n3]', 'resetWhen' => ['year' => false, 'month' => false, 'day' => true]];
        ...
        $string  = 'Ym[n5]|0,1,0';
        $rule    = new IssueRules($string);
        $expects = ['format' => 'Ym[n5]', 'resetWhen' => ['year' => false, 'month' => true, 'day' => false]];
        ...
        $string  = 'Y[n8]|1,0,0';
        $rule    = new IssueRules($string);
        $expects = ['format' => 'Y[n8]', 'resetWhen' => ['year' => true, 'month' => false, 'day' => false]];
